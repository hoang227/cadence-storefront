        ...
        return (
          <div className="relative ">
            ...
            <button
              ...
              className="w-full py-5 px-8 text-white font-source text-base tracking-wider 
              transition-all duration-300 ease-in-out flex items-center justify-center gap-3 relative overflow-hidden
            ...
            {isLoading && (
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-brand-cream">
                <div className="h-full bg-gradient-to-r from-brand-gold to-brand-navy animate-progress"></div>
              </div>
            )}
          </div>
        );
