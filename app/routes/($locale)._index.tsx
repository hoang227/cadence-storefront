      ...
      <section className="py-20 px-4 bg-brand-navy text-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <blockquote className="font-playfair text-2xl md:text-3xl mb-8">
            &ldquo;The attention to detail and quality of craftsmanship in every
            CADENCE shoe is simply unmatched. True artisanal excellence. &rdquo;
          </blockquote>
